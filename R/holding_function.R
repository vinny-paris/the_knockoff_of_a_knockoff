...
#' @param fdr The "False Discovery Rate", allowed to be between 0,1. Defaults to .2, implying that 1/5 of variables returned will be a type 1 error. This will be passed to the my_kn function.
